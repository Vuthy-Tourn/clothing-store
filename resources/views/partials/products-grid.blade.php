        ...
        <div class="group">
            ...
            <a href="{{ route('product.view', ['slug' => $product->slug]) }}"
                ...
                <div class="absolute top-5 right-5 flex flex-col gap-2">
                    @if ($product->is_new)
                        <span
                            class="px-3 py-1.5 bg-black text-white text-xs font-bold tracking-widest uppercase whitespace-nowrap">
                            New
                        </span>
                    @endif
                    ...
                    @if ($product->is_featured)
                        <span
                            class="px-3 py-1.5 bg-red-600 text-white text-xs font-bold tracking-widest uppercase whitespace-nowrap">
                            Featured
                        </span>
                    @endif
                    ...
                    @if ($product->IsOnSale())
                        <span
                            class="px-3 py-1.5 bg-green-600 text-white text-xs font-bold tracking-widest uppercase whitespace-nowrap">
                    ...
                    @if ($product->is_out_of_stock)
                        <span
                            class="px-3 py-1.5 bg-gray-600 text-white text-xs font-bold tracking-widest uppercase whitespace-nowrap">
                            Out of Stock
                        </span>
                    @endif
                </div>
        ...
        <div class="flex items-center gap-2" id="paginationContainer">
            ...
            @if ($end < $last)
                @if ($end < $last - 1)
                    <span class="pagination-item pagination-dots">...</span>
                @endif
                <a href="{{ $products->url($last) }}" class="pagination-item pagination-number"

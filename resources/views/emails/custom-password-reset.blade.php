...
<body>
    <div class="email-container">
        ...
        <div class="email-header">
            <div class="brand-logo">Nova Studio</div>
        ...
        <div class="email-content">
            ...
            <!-- Introduction -->
            <p class="intro-text">
                We received a request to reset your password for your Nova Studio account.
        ...
        <div class="email-footer">
            ...
            <div class="copyright">
                © {{ date('Y') }} Nova Studio. All rights reserved.<br>

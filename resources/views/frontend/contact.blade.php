...
@section('title', __('messages.contact_us') . ' - Outfit Store')
@section('content')
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start group">
                            <div class="bg-gray-100 p-3 rounded-lg group-hover:bg-gray-900 transition-colors duration-300">
                                <svg class="h-6 w-6 text-gray-900 group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="ml-4">
                                ...
                                <a href="mailto:support@outfitstore.com" class="text-gray-900 font-medium hover:text-gray-600 transition-colors">
                                    support@outfitstore.com
                                </a>
                            </div>
                        </div>
                        <div class="flex items-start group">
                            ...
                            <div class="ml-4">
                                ...
                                <a href="tel:+15551234567" class="text-gray-900 font-medium hover:text-gray-600 transition-colors">
                                    +1 (555) 123-4567
                                </a>
                            </div>
                        </div>
            ...
            <div class="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-8 md:p-12 text-center shadow-xl mb-12">
                ...
                <div class="flex justify-center space-x-6">
                    <a href="https://instagram.com/outfitstore" target="_blank" 
                       class="bg-white/10 backdrop-blur-sm p-4 rounded-full hover:bg-white hover:scale-110 transition-all duration-300 group">
                        <svg class="h-7 w-7 text-white group-hover:text-gray-900 transition-colors" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="https://x.com/outfitstore" target="_blank" 
                       class="bg-white/10 backdrop-blur-sm p-4 rounded-full hover:bg-white hover:scale-110 transition-all duration-300 group">
                        <svg class="h-7 w-7 text-white group-hover:text-gray-900 transition-colors" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                        </svg>
                    </a>
                    <a href="https://pinterest.com/outfitstore" target="_blank" 
                       class="bg-white/10 backdrop-blur-sm p-4 rounded-full hover:bg-white hover:scale-110 transition-all duration-300 group">
                        <svg class="h-7 w-7 text-white group-hover:text-gray-900 transition-colors" fill="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Brand Mission -->
            <div class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 md:p-12 text-center border border-gray-200">

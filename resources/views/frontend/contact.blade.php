...
@section('title', 'Contact Us - Outfit Store')
@section('content')
    ...
    <section class="py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                ...
                <p class="mt-4 text-lg text-gray-600">We’re here to help you find the perfect outfit. Reach out to us
                    anytime!</p>
            </div>
            ...
            <div class="mt-8 text-center">
                ...
                <a href="{{ url('/') }}#emails"
                    class="mt-4 inline-block py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium bg-[#536451] text-[#f3e9d5] hover:bg-[#f3e9d5] hover:text-[#536451] hover:scale-105 transition-transform duration-200 px-4 py-2 rounded ">Sign
                    Up Now</a>
            </div>
            ...
            <div class="mt-8 text-center">
                ...
                <p class="mt-2 text-gray-600 max-w-2xl mx-auto">At Outfit Store, we believe in empowering everyone to
                    express their unique style through sustainable, high-quality fashion. Join us in redefining what it
                    means to look and feel your best!</p>
            </div>
        </div>
    </section>

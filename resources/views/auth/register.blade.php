...
@section('title', __('messages.create_account') . ' - Nova Studio')
    ...
    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="text-center slide-in slide-in-1">
            <div class="relative inline-block">
                <div
                    class="w-20 h-20 rounded-full border-3 border-white shadow-md overflow-hidden bg-gray-100 flex items-center justify-center">
                    <div id="profile-preview" class="w-full h-full flex items-center justify-center">
                        <i class="fas fa-user text-gray-400 text-2xl"></i>
                    </div>
                </div>
                <label for="profile_picture"
                    class="absolute bottom-0 right-0 w-8 h-8 bg-black rounded-full flex items-center justify-center cursor-pointer hover:scale-110 transition-transform duration-300 shadow-md">
            ...
            <div id="additional-info" class="hidden space-y-4 mt-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="gender" class="form-input w-full px-3 py-2 text-sm rounded">
                ...
                <div>
                    ...
                    <textarea name="address" rows="2" class="form-input w-full px-3 py-2 text-sm rounded"
        ...
        <div class="slide-in slide-in-4">
            <label class="flex items-start text-sm text-gray-medium">
                <input type="checkbox" name="terms" class="custom-checkbox mr-2 mt-0.5" required>

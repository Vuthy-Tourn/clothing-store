...
@section('content')
    <div class="flex justify-between items-center mb-6" data-aos="fade-down">
        ...
        <a href="javascript:void(0)" onclick="CategoryModal.openAdd()"
                ...
                @forelse ($categories as $index => $category)
                    <tr class="border-b hover:bg-gray-50" data-aos="fade-up" data-aos-delay="{{ $index * 100 }}">
                        ...
                        <td class="py-3 px-6 text-center">
                            <span
                                class="{{ $category->status === 'active' ? 'bg-green-100 text-green-700' : 'bg-gray-200 text-gray-600' }} text-xs px-2 py-1 rounded-full">

...
@section('title', 'Dashboard - Nova Studio Admin')
...
@section('content')
                    ...
                    <thead>
                        <tr class="border-b border-gray-200">
                            <th class="text-left py-3 px-4 text-sm font-semibold text-gray-700">
                                {{ __('admin.recent_activity.order') }}</th>
                            <th class="text-left py-3 px-4 text-sm font-semibold text-gray-700">
                                {{ __('admin.recent_activity.customer') }}</th>
                            <th class="text-left py-3 px-4 text-sm font-semibold text-gray-700">
                                {{ __('admin.recent_activity.amount') }}</th>
                            <th class="text-left py-3 px-4 text-sm font-semibold text-gray-700">
                                {{ __('admin.recent_activity.status') }}</th>
                            <th class="text-left py-3 px-4 text-sm font-semibold text-gray-700">
                                {{ __('admin.recent_activity.date') }}</th>
                        </tr>
                    </thead>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <a href="{{ route('admin.orders.index') }}" class="card p-6 hover:shadow-lg transition-shadow" data-aos="fade-up"
            data-aos-delay="50">
            <div class="flex items-center gap-4">
        ...
        <a href="{{ route('admin.categories.index') }}" class="card p-6 hover:shadow-lg transition-shadow"
        ...
        <button onclick="refreshDashboard()" class="card p-6 hover:shadow-lg transition-shadow text-left" data-aos="fade-up"
            data-aos-delay="150">
            <div class="flex items-center gap-4">

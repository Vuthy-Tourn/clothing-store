    ...
    <section class="mt-8" data-aos="fade-down">
        <div class="flex flex-col md:flex-row md:justify-between md:items-center mb-8">
            <div class="mb-4 md:mb-0">
                ...
                <p class="text-gray-600 text-lg">Manage the newest products displayed in the store's new arrivals section.
                </p>
            </div>
            <div>
        ...
        @if (session('success'))
            <div class="mb-6 bg-gradient-to-r from-emerald-50 to-emerald-100 border border-emerald-200 text-emerald-700 px-4 py-3 rounded-lg flex items-center shadow-sm"
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl overflow-hidden hover:shadow-xl transition-all duration-300 group"
                        ...
                        <div class="relative w-full pt-[100%] bg-gradient-to-br from-gray-50 to-gray-100 overflow-hidden">
                            ...
                            <div class="absolute top-3 right-3 z-10">
                                <span
                                    class="px-3 py-1.5 rounded-full text-xs font-medium shadow-lg {{ $arrival->status === 'active' ? 'bg-gradient-to-r from-emerald-500 to-emerald-600 text-white' : 'bg-gradient-to-r from-gray-400 to-gray-500 text-white' }}">
                            ...
                            <div
                                class="absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-center justify-center">
                                <div
                                    class="flex space-x-2 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                                    <button
                                        onclick="NewArrivalModal.openEdit('{{ $arrival->id }}', '{{ $arrival->name }}', `{{ addslashes($arrival->description) }}`, '{{ asset($arrival->image) }}', '{{ $arrival->status }}', '{{ $arrival->price }}')"
                                    ...
                                    <form action="{{ route('admin.new-arrivals.destroy', $arrival->id) }}" method="POST"
                                        class="inline-block">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                        ...
                        <div class="p-4">
                            <h3
                                class="text-base font-bold text-gray-900 mb-2 line-clamp-1 group-hover:text-gray-700 transition-colors">
                                {{ $arrival->name }}</h3>
                            <p class="text-gray-600 text-sm mb-4 line-clamp-2 leading-relaxed">{{ $arrival->description }}
                            </p>
                            ...
                            <div class="flex justify-between items-center border-t border-gray-100 pt-4">
                                <div class="flex items-center">
                                    <span
                                        class="bg-gradient-to-r from-gray-900 to-gray-800 text-white px-3 py-1.5 rounded-lg text-sm font-bold shadow-sm">
        ...
        @else
            <!-- Empty State -->
            <div class="bg-gradient-to-br from-white to-gray-50 border-2 border-dashed border-gray-200 rounded-2xl p-12 text-center transition-all hover:border-gray-300"
                ...
                <p class="text-gray-600 text-base mb-6 max-w-md mx-auto">Start showcasing your latest products by adding
                    them to the new arrivals section.</p>
                <button onclick="NewArrivalModal.openAdd()"
                        ...
                        <div>
                            ...
                            <div class="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-gray-400 transition-colors group cursor-pointer"
                                ...
                                <div class="flex flex-col items-center">
                                    <div
                                        class="w-12 h-12 bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl flex items-center justify-center mb-3 group-hover:scale-110 transition-transform">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="mb-3">
                                <div
                                    class="bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 p-4 rounded-xl">
                                    <div class="relative w-full pt-[100%]">

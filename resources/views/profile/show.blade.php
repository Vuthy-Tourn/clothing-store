...
@section('content')
                        ...
                        <div class="flex flex-col md:flex-row md:items-end md:justify-between">
                                ...
                                <div class="ml-28 md:ml-36">
                                    ...
                                    @if ($user->customer_id)
                                        <p class="text-gray-300 text-sm mt-1">
                                            <i class="fas fa-id-card mr-1"></i> {{ __('messages.customer_id') }}:
                                            {{ $user->customer_id }}
                                        </p>
                                    @endif
                                </div>
                            ...
                            <div class="mt-4 md:mt-0 md:mb-4 flex flex-col space-y-2">
                                ...
                                @if ($user->loyalty_points > 0)
                                    <div
                                        class="bg-gradient-to-r from-yellow-500 to-yellow-600 bg-opacity-20 px-4 py-2 rounded-xl">
                                        <p class="text-yellow-300 text-sm font-medium">
                                            <i class="fas fa-star mr-1"></i> {{ $user->loyalty_points }}
                        ...
                        <div class="p-6 rounded-2xl border border-gray-200 shadow-sm">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-900 font-medium">{{ $user->phone ?? __('messages.not_provided') }}
                                    </p>
                                </div>
                                <div>
                            ...
                            @if ($addresses->count() > 0)
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    @foreach ($addresses as $address)
                                        <div
                                            class="border border-gray-200 rounded-xl p-4 hover:border-gray-300 transition {{ $address->is_default ? 'border-2 border-gray-500 bg-gray-50' : '' }}">
    ...
    <div id="addressModal" class="fixed inset-0 z-50 hidden">
        ...
        <div class="modal-container flex items-center justify-center min-h-screen p-4">
            <div
                class="modal-content bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[95vh] overflow-hidden transform transition-all duration-300 scale-95 opacity-0">
                <!-- Modal Header -->
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <h3 class="text-xl font-semibold text-gray-900" id="modalTitle">
                                    {{ __('messages.add_new_address') }}</h3>
                ...
                <div class="overflow-y-auto max-h-[calc(90vh-120px)] scrollbar-hide">
                    <div class="px-6 py-2">
                            ...
                            <div class="space-y-6">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input type="text" name="address_name" id="address_name"
                                                ...
                                                class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-1 outline-0 focus:ring-gray-500 focus:border-gray-500 transition">
                                        </div>
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700 mb-1">
                                                {{ __('messages.full_name_star') }} <span class="text-red-500">*</span>
                                            </label>
                                        ...
                                        <div class="md:col-span-2">
                                            <label class="block text-sm font-medium text-gray-700 mb-1">
                                                {{ __('messages.phone_number_star') }} <span class="text-red-500">*</span>
                                            </label>
                                ...
                                <div class="bg-gray-50 p-4 rounded-xl">
                                    ...
                                    <div class="space-y-4">
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700 mb-1">
                                                {{ __('messages.address_line1_star') }} <span class="text-red-500">*</span>
                                            </label>
                                        ...
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700 mb-1">
                                                {{ __('messages.address_line2_star') }} <span class="text-red-500">*</span>
                                            </label>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                            <div>
                                                <label class="block text-sm font-medium text-gray-700 mb-1">
                                                    {{ __('messages.city_star') }} <span class="text-red-500">*</span>
                                                </label>
                                            ...
                                            <div>
                                                <label class="block text-sm font-medium text-gray-700 mb-1">
                                                    {{ __('messages.state_star') }} <span class="text-red-500">*</span>
                                                </label>
                                            ...
                                            <div>
                                                <label class="block text-sm font-medium text-gray-700 mb-1">
                                                    {{ __('messages.zip_code_star') }} <span class="text-red-500">*</span>
                                                </label>
                                        ...
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700 mb-1">
                                                {{ __('messages.country_star') }} <span class="text-red-500">*</span>
                                            </label>
                                            ...
                                            <label class="flex items-center cursor-pointer">
                                                <div class="relative">
                                                    <input type="checkbox" name="is_default" id="is_default"
                                                        class="sr-only peer">
                                                    <div
                                                        class="w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-1 outline-0 peer-focus:ring-gray-500 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-gray-600">
                                                    </div>
                                                </div>
                                                <span class="ml-3 text-sm font-medium text-gray-700">
                                                    {{ __('messages.set_as_default_address') }}
                                                    <span
                                                        class="block text-xs text-gray-500">{{ __('messages.use_default_address') }}</span>
                                                </span>
                                            </label>
                                        </div>
                                    </div>
                ...
                <div class="sticky bottom-0 bg-white border-t border-gray-200 px-6 py-4">
                    <div class="flex justify-between items-center">
                        ...
                        <button type="submit" form="addressForm" id="addressSubmitBtn"
                            class="px-5 py-2.5 bg-gradient-to-r from-gray-600 to-gray-700 text-white rounded-lg font-medium hover:from-gray-700 hover:to-gray-800 transition hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2">
    ...
    <div id="loadingOverlay" class="fixed inset-0 bg-white bg-opacity-80 flex items-center justify-center z-[60] hidden">
        <div class="text-center">
            <div class="w-16 h-16 border-4 border-gray-600 border-t-transparent rounded-full animate-spin mx-auto mb-4">
            </div>
        ...
        class AddressOperations {
            ...
            async setDefaultAddress(id) {
                try {
                    ...
                    if (data.success) {
                        ...
                        this.modalManager.showToast(data.message || '{{ __('messages.error_updating_address') }}',
                            'error');
                    }
                } catch (error) {
                    console.error('Error:', error);
                ...
                if (result.isConfirmed) {
                    try {
                        ...
                        if (data.success) {
                            ...
                            this.modalManager.showToast(data.message || '{{ __('messages.failed_delete_address') }}',
                                'error');
                        }
                    } catch (error) {
                        console.error('Error:', error);
            ...
            updateDefaultAddressUI(selectedId) {
                ...
                addressCards.forEach(card => {
                    ...
                    card.classList.remove('border-2', 'border-gray-500', 'bg-gray-50');

                    const header = card.querySelector('.flex.justify-between div:first-child');
                    if (header) {
                        const defaultBadge = header.querySelector('.bg-gray-100');
                ...
                addressCards.forEach(card => {
                    ...
                    if (addressBtn) {
                        card.classList.add('border-2', 'border-gray-500', 'bg-gray-50');

                        const header = card.querySelector('.flex.justify-between div:first-child');
                        if (header) {
                            const badge = document.createElement('span');
                            badge.className =
                                'inline-block bg-gray-100 text-gray-800 text-xs px-2 py-1 rounded-full ml-2';
                            badge.innerHTML =

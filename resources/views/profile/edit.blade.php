    ...
    @enderror
                        ...
                        <div class="lg:w-80 flex flex-col items-center">
                            <div class="space-y-4 w-full">
                                <label class="block font-semibold text-gray-900 text-center">Profile Picture</label>

                                <!-- Profile Picture Preview -->
                                <div class="relative group">
                                     @if ($user->profile_picture)
                <img src="{{ asset('storage/' . $user->profile_picture) }}" alt="Profile Picture" id="profilePreview"

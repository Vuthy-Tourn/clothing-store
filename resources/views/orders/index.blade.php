    ...
    <div class="max-w-7xl mx-auto px-4">
        ...
        @else
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6 mb-8">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-300 hover:scale-105">
                    <!-- Order Header -->
                    ...
                    <div class="p-6 border-b border-gray-100">
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center gap-3">
                                <img src="{{ Str::startsWith($item->product->image, ['http://', 'https://'])
                                            ? $item->product->image
                                            : asset('storage/' . $item->product->image) }}"
                                     alt="{{ $item->product_name }}"
                                     class="w-12 h-12 object-cover rounded-lg">
                                <div class="flex-1 min-w-0">
                                    <p class="font-medium text-gray-900 text-sm line-clamp-1">{{ $item->product_name }}</p>
                            ...
                            <div class="text-center">
                                <span class="text-sm text-gray-500">+{{ $order->items->count() - 2 }} more items</span>
                            </div>
                            @endif
                        </div>
                    </div>
